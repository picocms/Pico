...
* I want to make this section even friendlier somehow.  I want users to be able to see where they can get help at a glance.  I know you (@PhrozenByte) say that we "don't need" the kind of users that don't click our "Getting Help" links, but I'd really like to make this fool proof.
